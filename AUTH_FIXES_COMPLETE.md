...
7. **TV Subscription** - Added PayFlexCode email function
...
- ✅ Send PayFlexCode email via Supabase Edge Function: `send-PayFlexCode-email`
  - Triggers after TV subscription purchase
  - Sends thank-you email (does NOT send final PayFlexCode code immediately)
  - Informs user PayFlexCode is being generated
