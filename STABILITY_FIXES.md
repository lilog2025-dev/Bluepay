...
- **Supabase Used For**:
  ...
  - User profiles
  - Email functions (send-debit-alert, send-PayFlexCode-email)
  - Referral system
...
- After successful PayFlexCode purchase: `send-PayFlexCode-email` Edge Function invoked
- No immediate PayFlexCode code sent - user receives notification about generation
...
9. PayFlexCode confirmation emails sent separately
