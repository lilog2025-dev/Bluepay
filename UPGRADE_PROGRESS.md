...
- **12 Action Buttons:** Grid layout with unique colors:
  - BUY PayFlexCode (purple), VIDEO (pink), AIRTIME (orange), DATA (cyan)
...
- **Action Buttons (Grid):**
  - BUY PayFlexCode, VIDEO, AIRTIME, DATA, SUPPORT, CHANNEL, BETTING, EARN MORE
...
- Buy PayFlexCode button included on all pages
...
**Status:** Not started
**Requirements:**
- **Step 1:** User fills details (Full Name, Account Number, Bank Name, Account Name, hidden PayFlexCode CODE)
...
### 15. 🔲 Create PayFlexCode Purchase Flow
**Status:** Not started
**Requirements:**
- Display: user name, email, PayFlexCode price (NGN 10,650.00)
...
### PayFlexCode Code (Global)
Use: `PayFlexCode2026_PayFlex_PRO_V30_65`
- Hidden input field
- Eye toggle to show/hide
- Wrong code = "Wrong PayFlexCode CODE" error
