...
export default function DashboardPage() {
  ...
  useEffect(() => {
    const marqueeInterval = setInterval(() => {
      setCurrentMarqueeIndex((prev) => (prev + 1) % transactions.length)
    }, 4000)
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-28 relative">
      ...
      <a
        ...
        className="fixed bottom-32 right-6 z-40 group animate-bounce"
      >
        <div className="bg-gradient-to-r from-green-400 to-green-500 rounded-full p-4 shadow-lg hover:shadow-xl hover:scale-110 transition-all duration-300 cursor-pointer">
      ...
      <header className="sticky top-0 z-50 bg-[#0000ff] text-white">
        ...
        {/* Transaction Marquee */}
        <div className="bg-blue-600 overflow-hidden py-2">
      ...
      <main className="px-4 py-6 max-w-2xl mx-auto">
        {activeTab === 'home' && (
          <>
            ...
            {/* Balance Card */}
            <div className="bg-[#0000ff] rounded-3xl p-6 text-white shadow-lg mb-6">
              <div className="mb-6">
                <p className="text-white/70 text-sm mb-2">Available Balance</p>
                <div className="flex items-center gap-3 mb-4">
                  <h2 className="text-4xl font-bold">
                    {showBalance ? 'NGN 200,000.00' : '••••••••'}
                  </h2>
                  <button
                ...
                <div>
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <p className="font-bold">NGN200,000</p>
                  </div>
              ...
              <button
                ...
                className="w-fit px-6 py-2 bg-white text-[#0000ff] font-bold rounded-full hover:opacity-90 transition"
              >
                Withdraw
              </button>
            </div>
            ...
            <h3 className="text-base font-bold text-gray-900 mb-4">More Services</h3>
            <div className="grid grid-cols-4 gap-3 mb-8">
            ...
            <div className="bg-gray-200 rounded-2xl h-40 flex items-center justify-center text-gray-400 font-bold mb-6">
              <div className="text-center">
                <p>Advertisement</p>
                <p className="text-sm">Carousel Area</p>
              </div>
            </div>
          </>
        )}
        ...
        {activeTab === 'wallet' && (
          <div className="text-center py-12">
            ...
            <h2 className="text-xl font-bold text-gray-900 mb-2">Wallet</h2>
        ...
        {activeTab === 'transactions' && (
          <div className="text-center py-12">
            ...
            <h2 className="text-xl font-bold text-gray-900 mb-2">Transactions</h2>
            <p className="text-gray-600">Coming soon</p>
          </div>
        )}
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 max-w-2xl mx-auto shadow-2xl">
        <div className="flex justify-around items-center">
          ...
          <button
            ...
            className={`flex-1 flex flex-col items-center justify-center py-4 transition-colors ${
              activeTab === 'wallet' ? 'text-pink-500' : 'text-gray-600'
            }`}
          >
