...
export default function ElectricityPage() {
  ...
  const providers = ['EKEDC', 'IKEDC', 'KEDCO', 'BEDC', 'PHCN', 'Ikeja Electric', 'Enugu Electric']
  ...
  const handleProceed = async () => {
    ...
    try {
      ...
      await sendDebitAlert({
        ...
        recipient_name: selectedProvider,
        recipient_account_number: meterNumber,
        recipient_bank_name: 'Electricity Provider',
        transaction_id: txId,
      ...
      await recordTransaction(userId, {
        ...
        description: `Electricity purchase from ${selectedProvider}`,
        sessionId: sId,
      })
    } catch (err) {
      console.error('[v0] Error processing electricity purchase:', err)
    } finally {
      setLoading(false)
    }
  }
          ...
          <div className="bg-gradient-to-b from-green-50 to-blue-50 rounded-2xl p-6 text-center">
            ...
            <div className="bg-white rounded-xl p-4 border border-gray-200 space-y-3 mb-6 text-left">
              ...
              <div>
                ...
                <p className="font-bold text-gray-900">{selectedProvider}</p>
              </div>
              <div>
                <p className="text-xs text-gray-600 mb-1">Meter Number</p>
                <p className="font-mono font-bold text-gray-900">{meterNumber}</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="font-bold text-gray-900">Electricity Purchase</p>
              </div>
              <div>
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center pb-8">
        <div className="max-w-2xl mx-auto px-4 text-center">
          ...
          <p className="text-gray-600 text-lg">
            {step === 'countdown1' ? 'Processing your electricity purchase...' : 'Finalizing your transaction...'}
          </p>
      ...
      <div className="min-h-screen bg-gray-50 pb-8">
        ...
        <div className="max-w-2xl mx-auto px-4 pt-6">
          <div className="bg-white rounded-xl p-6 border border-gray-200 space-y-4 mb-6">
            <h3 className="font-bold text-gray-900 text-lg">Purchase Summary</h3>

            <div className="space-y-3">
              <div className="flex justify-between pb-3 border-b border-gray-200">
                <span className="text-gray-600">Provider</span>
                <span className="font-bold text-gray-900">{selectedProvider}</span>
              </div>
              <div className="flex justify-between pb-3 border-b border-gray-200">
                <span className="text-gray-600">Meter Number</span>
                <span className="font-mono font-bold text-gray-900">{meterNumber}</span>
              </div>
    ...
    <div className="min-h-screen bg-gray-50 pb-8">
      <header className="sticky top-0 z-40 bg-white border-b border-gray-200">
        <div className="flex items-center gap-3 max-w-2xl mx-auto px-4 py-4">
          ...
          <h1 className="text-xl font-bold text-gray-900">Buy Electricity</h1>
        </div>
      </header>
      ...
      <div className="max-w-2xl mx-auto px-4 pt-6">
        ...
        <div className="space-y-4">
          <div>
            <label className="block text-sm font-semibold text-gray-900 mb-2">Select Provider</label>
            <select
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#0000ff]"
            />
            <p className="text-xs text-gray-600 mt-1">11 digits required</p>
          </div>
