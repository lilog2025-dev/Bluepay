            ...
            <div className="bg-[#1a1c23] border border-white/10 rounded-2xl sm:rounded-3xl p-5 sm:p-8 mb-4 sm:mb-6 shadow-2xl">
              <form onSubmit={handleSendOtp} className="space-y-4 sm:space-y-6">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full px-4 sm:px-6 py-3 sm:py-4 bg-blue-600 hover:bg-blue-500 text-white font-bold text-sm sm:text-lg rounded-xl sm:rounded-2xl shadow-xl disabled:opacity-75 transition-all duration-300"
                >
          ...
          <div>
            ...
            <div className="bg-[#1a1c23] border border-white/10 rounded-2xl sm:rounded-3xl p-5 sm:p-8 mb-4 sm:mb-6 shadow-2xl">
              <form onSubmit={handleVerifyOtp} className="space-y-6">
                ...
                <button 
                  type="button" 
                  onClick={() => { setStep('send'); setOtp(Array(6).fill('')) }} 
