  ...
  return (
    <div className="min-h-screen bg-[#0000ff] flex flex-col items-center justify-center px-4">
      <div className="text-center max-w-md">
        <h1 className="text-3xl font-bold text-white mb-4">Signup Error</h1>
        <p className="text-white/80 text-lg mb-2">We&apos;re having trouble creating your account.</p>
        ...
        <div className="flex gap-3 justify-center flex-col">
          ...
          <Link href="/signin" className="px-6 py-3 bg-blue-400 text-white font-bold rounded-lg hover:bg-blue-500 transition-all text-center">
            Sign In Instead
          </Link>
        </div>
      </div>
