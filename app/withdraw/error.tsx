...
export default function WithdrawError({
  ...
  useEffect(() => {
    console.error('[v0] Withdraw page error:', error)
  }, [error])
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-600 to-blue-800 flex flex-col items-center justify-center px-4">
      <div className="text-center max-w-md">
        <h1 className="text-3xl font-bold text-white mb-4">Transaction Error</h1>
        <p className="text-white/80 text-lg mb-2">Something went wrong while processing your withdrawal.</p>
